        ...
        <div className={styles.aboutUsDescContainer}>
          <div className={styles.aboutUsTextsContainer}>
            ...
            <div className={styles.aboutUsTextsDesc}>
              ...
              მომხმარებელზე ორიენტირებული აკადემია. EduCity მომხმარებელს
              სთავაზობს პროფესიულ პროგრამებს მარკეტინგის, ტექნოლოგიების,
              დიზაინისა და მენეჯმენტის მიმართულებით. სწავლება ყოველთვის
              დაფუძნებულია პრაქტიკულ მაგალითებზე. რის შესაძლებლობასაც გვაძლევს
              ჩვენ სფეროებში მრავალწლიანი გამოცდილების მქონე, Senior პოზიციებზე
              მყოფი მენტორები.
            </div>
          </div>
