        ...
        <div className={styles.becomePartnerInfoContainer}>
          <div className={styles.becomePartnerInfoTexts}>
            <div className={styles.becomePartnerInfoTitle}>
              გახდი EduCity-ის პარტნიორი და შექმენი ახალი შესაძლებლობები!
            </div>
            <div className={styles.becomePartnerInfoDescription}>
              ჩვენ გთავაზობთ თანამშრომლობას სხვადასხვა მიმართულებით: შეგიძლია
              დააფინანსო შშმ პირების ან სოციალურად დაუცველი სტუდენტების სწავლა,
              დაეხმარო მათ კარიერის შექმნაში და განათლების ხელმისაწვდომობის
              გაზრდაში. ასევე, ვთავაზობთ კორპორატიულ გადამზადებას კომპანიებს,
              რომლებიც დაინტერესებულნი არიან საკუთარი გუნდის პროფესიული
              განვითარებით. თუ ეძებ კვალიფიციურ კადრებს, შეგიძლია დასაქმების
              შესაძლებლობა მისცე ჩვენს გადამზადებულ სპეციალისტებს.
            </div>
          </div>
            ...
            <div>
              ...
              {active === 0 && (
                <div className={styles.becomePartnerFormDescription}>
                  ჩვენ გთავაზობთ პროფესიონალ კადრებს, რომლებიც მზად არიან დიდი
                  მოტივაციით ჩაერთონ კომპანიის საქმიანობაში და შეიტანონ
                  მნიშვნელოვანი წვლილი მის განვითარებაში. თუ გჭირდებათ
                  სპეციალისტი კონკრეტულ მიმართულებაში, დაგვიკავშირდით და
                  შეგირჩევთ შესაბამის კადრს თქვენი საჭიროებების მიხედვით.
                </div>
              )}
